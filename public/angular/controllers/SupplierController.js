app.controller('SupplierController',['$scope','$http','API_URL',function($scope,$http,API_URL){
	//Retrieve Supplier linsting from API
	...
	$scope.save=function(modalstate,id){
		...
		$http({
			...
			console.log(response);
			alert('This is embarassing. An error has ocurred. Please check the log for details');
